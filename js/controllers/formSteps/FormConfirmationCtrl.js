/* global app */
app.controller('FormConfirmationCtrl', ['$scope', '$state', 'FormDataFactory', 'FormApiFactory', 'FormHelperFactory', function FormConfirmationCtrl($scope, $state, FormDataFactory, FormApiFactory, FormHelperFactory) {
