...
app.controller('FormCourseListCtrl', ['$scope', '$state', '$mdDialog', 'FormDataFactory', 'FormApiFactory', function FormCourseListCtrl($scope, $state, $mdDialog, FormDataFactory, FormApiFactory) {
