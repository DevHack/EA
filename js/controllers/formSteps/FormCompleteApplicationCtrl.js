...
function FormCompleteApplicationCtrl($scope, $state, FormDataFactory, FormApiFactory) {
...
FormCompleteApplicationCtrl.$inject = ['$scope', '$state', 'FormDataFactory', 'FormApiFactory'];
